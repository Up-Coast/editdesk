...
- Typing at the very start or end of a link would put the text outside the link. The editor inserts it inside
...
| Typed text is always encoded for where it is written                                                             | Typed `<script>` or `${}` becoming markup or code                                   |
